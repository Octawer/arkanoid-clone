#ifndef __ALT_BLOCK_GENERATOR_H__
#define __ALT_BLOCK_GENERATOR_H__
...
class AltBlockGenerator : public IBlockGenerator
{
...
public:
	...
	AltBlockGenerator() : IBlockGenerator() 
	{
		// init rand seed
		srand (time(NULL));
		_rows = rand() % 7 + 1; // [1-7]
...
#endif /* __ALT_BLOCK_GENERATOR_H__ */